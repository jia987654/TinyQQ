...
void net::Socket::setFd(int fd)
{
	m_fd = fd;
}

int net::Socket::getFd()
{
	return m_fd;
}

void net::Socket::bind(IPAddress& addr)
{
...
void net::Socket::listen(int nums)
{
...
int net::Socket::accept(IPAddress* addr)
{
